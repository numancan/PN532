...
/*! 
    ...
    If the card has a 4-uint8_t UID it is probably a Mifare
    ...
    If the card has a 7-uint8_t UID it is probably a Mifare
    Ultralight card, and the 4 uint8_t pages can be read directly.
...
void loop(void) {
  ...
  if (success) {
    ...
    if (uidLength == 7)
    {
      ...
      Serial.println("Seems to be a Mifare Ultralight tag (7 uint8_t UID)");
